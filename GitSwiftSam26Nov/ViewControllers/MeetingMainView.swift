...
struct MeetingMainView: View {
    // The Core Data context environment variable.
    @Environment(\.modelContext) private var modelContext
    // A query to fetch items of type Item.
    @Query private var items: [Item]

    // The view uses a List to display items fetched from a Core Data entity (Item).
    var body: some View {
        NavigationSplitView {
            List {
